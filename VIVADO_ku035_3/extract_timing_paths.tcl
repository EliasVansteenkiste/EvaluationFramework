...
puts "Start Analysis:"
puts "Analyzing $argv endpoints..."

set worstList [get_timing_paths -delay_type max -max_paths 10000 -nworst $argv -slack_lesser_than 1 -no_report_unconstrained -sort_by group]
