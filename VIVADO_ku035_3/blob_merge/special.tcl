...
read_verilog -library  work  "blob_merge.v"

set TopModule RLE_BlobMerging
...
# Disable carry inferring
set_param synth.elaboration.rodinMoreOptions "$oldMoreOptions ;rt::set_parameter enableCarry false"
set oldMoreOptions [get_param synth.elaboration.rodinMoreOptions]
