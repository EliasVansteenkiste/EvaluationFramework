...
(* keep = "true" *) reg [`NWIDTH-1:0] comp_N, N, mcount, ncount, Ndivk, mem_N;
reg [1:0] mode;
...
(* keep = "true" *) reg [3:0] cur_mem_state, next_mem_state;
(* keep = "true" *) reg [`RAMSIZEWIDTH-1:0] ram_addr;
...
reg [1:0] mem_read;
(* keep = "true" *) reg [`BLOCKWIDTH-1:0] mem_write_size, mem_write_size_buf, mem_read_size;
wire mem_done;
...
ram currentBlock1 (curWriteByteEn1, clk, curWriteData1, curReadAddr1, curWriteAddr1, curWriteEn1, curReadData1 ); //ram1
// store left blocks data
ram leftBlock0(leftWriteByteEn0, clk, leftWriteData0, leftReadAddr0, leftWriteAddr0, leftWriteEn0, leftReadData0 );//ram2
ram leftBlock1(leftWriteByteEn1, clk, leftWriteData1, leftReadAddr1, leftWriteAddr1, leftWriteEn1, leftReadData1 );//ram3
...
(* keep = "true" *) reg[32-1:0] leftWriteByteEn;
(* keep = "true" *) reg[5-1:0] leftWriteAddr, leftReadAddr;
reg leftWriteEn;
...
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay0; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay1; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay2; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay3; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay4; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay5; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay6; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay7; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay8; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay9; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay10; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay11; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay12; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay13; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay14; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay15; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay16; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay17; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay18; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay19; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay20; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay21; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay22; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay23; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay24; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay25; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay26; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay27; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay28; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay29; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay30; 
(* keep = "true" *) reg[5-1:0]curWriteAddrDelay31; 

(* keep = "true" *) reg[5-1:0]curReadAddrDelay0; 
(* keep = "true" *) reg[5-1:0]curReadAddrDelay1; 
(* keep = "true" *) reg[5-1:0]curReadAddrDelay2; 
(* keep = "true" *) reg[5-1:0]curReadAddrDelay3; 
(* keep = "true" *) reg[5-1:0]curReadAddrDelay4; 
(* keep = "true" *) reg[5-1:0]curReadAddrDelay5; 
(* keep = "true" *) reg[5-1:0]curReadAddrDelay6; 
(* keep = "true" *) reg[5-1:0]curReadAddrDelay7; 
(* keep = "true" *) reg[5-1:0]curReadAddrDelay8; 
(* keep = "true" *) reg[5-1:0]curReadAddrDelay9; 
(* keep = "true" *) reg[5-1:0]curReadAddrDelay10; 
(* keep = "true" *) reg[5-1:0]curReadAddrDelay11; 
...
assign usedw = status_cnt[`wFIFOSIZEWIDTH-1:0];
    ...
    .widthad (`wFIFOSIZEWIDTH)
        ...
        .aclr0(0),
        .aclr1(0),
        .byteena_a({`wFIFOINPUTWIDTH/8 {1'b1}}),
        .byteena_b(0),
        .addressstall_a(0),
        .addressstall_b(0),
        .q_a(),
...
//			specialcase, flags);  
  ...
  assign still_tiny_or_tiny_and_denormround = stilltiny | (tiny & denormround);  
    ...
    flag flager(invalid, overflow, 
    	inexact_or_shiftloss, 
    	shiftloss_or_inexact, 
    	still_tiny_or_tiny_and_denormround,  
    	specialcase, 
    	flags);  
