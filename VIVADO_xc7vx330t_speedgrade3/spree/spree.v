...
//		assign constone = 32'b11111111111111111111111111111111;
		wire wren;
		assign wren = (c_we & (|c_reg));

//BRAM_TDP_MACRO regfile1_replace(
//.DOA(a_readdataout_temp),
//.DOB(dummy_out),
//.ADDRA(c_reg),
//.ADDRB(a_reg),
//.CLKA(clk),
...
//BRAM_TDP_MACRO regfile2_replace(
//.DOA(b_readdataout_temp),
//.DOB(dummywire),
//.ADDRA(c_reg),
//.ADDRB(b_reg),
//.CLKA(clk),
...
.widthad (14)
    ...
    .data_a(load_data),
    .data_b(boot_idata),
    .address_a(next_pc_wire),
    .address_b(boot_iaddr),
    .clock0(clk),
    .clock1(clk),
    .clocken0(1'b1),
    .clocken1(1'b1),
...
.widthad (14)
    ...
    .wren_a(will_be_wren1),
    .rden_a(~will_be_wren1),
    .wren_b(boot_dwe),
    .rden_b(~boot_dwe),
    .data_a(d_writedatamem),
    .data_b(boot_ddata),
    .address_a(memaddr_wrd),
