set design titan23_stereovision
set Part xcvu095-ffva1760-2-e-es1
set part xcvu095-ffva1760-2-e-es1
set xst 0
set sd 0
set tclscr 0
...
source /proj/fisdata/fisusr/sandboxes/ABE/ListFiles/bin/qor_synth_abetclLibs.tcl
create_project -force -part $part $design .

read_verilog -library work "LU64PEEng.v"
read_verilog -library work -sv "LU64PEEng.srcs/sources_1/new/LPM_xilinx_lib.sv"

set TopModule LU64PEEng
...
#synthesis parameters for cascade of LUTs
set lutSize 6
set_param synth.lutMapMode     0
set_param synth.dumpInfoMode   0
set_param synth.cutDecompMode  0
set_param synth.clut.format    "6"

# Enable extended LUT input sharing mode for LUTNM (eg 3-3) (default false)
#set_param synth.extendedLutInputSharing true;

# Use a maximal matching algorithm for LUTNM (default false)
#set_param synth.useMaximalMatching true;
...
source /proj/fisdata/fisusr/sandboxes/ABE/ListFiles/bin/mt4_only5profiles.tcl


#placer parameters for cascade of LUTs
# build shapes from cascade clusters
#set_param archplace.buildCascadeShapes ILR
#set_param place.evalarch.cascadeDelayScale 1.0
# set_param place.enablePrePlaceDrcChecks false
# set_param place.evalarch.lutPairInputs "ins=55 tot=6"
...
synth_design -part $Part -flatten_hierarchy none -keep_equivalent_registers -resource_sharing off
# synth_design -part $Part -flatten_hierarchy full
# write_edif design.edf
abe_planAhead::do_logic_opt
